        ...
        <div className="max-w-md w-full space-y-8 bg-white/5 p-10 rounded-2xl border border-white/10 backdrop-blur-md shadow-2xl">
          <div>
            ...
            <p className="mt-2 text-center text-sm text-gray-400">
              ...
              <Link href="/login" className="font-medium text-[#5227FF] hover:text-[#A991FF] transition-colors">
                Sign in
              </Link>
            </p>
          </div>
          <form className="mt-8 space-y-6" action="#" method="POST">
            <div className="rounded-md shadow-sm space-y-4">
              ...
              <div>
                ...
                <input id="password" name="password" type="password" required className="appearance-none rounded-lg relative block w-full px-4 py-3 bg-[#13111C]/50 border border-white/10 placeholder-gray-500 text-white focus:outline-none focus:ring-2 focus:ring-[#5227FF] focus:border-transparent sm:text-sm transition-all" placeholder="Password" />
              </div>
            </div>
          ...
          <div className="mt-6 text-center">
             <p className="text-gray-400 text-sm mb-4">Want to join Nexus University?</p>
